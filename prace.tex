...
\usepackage[				% Nastavení geometrie stránky
	...
	hmargin={15mm,15mm},	% Vnitřní a vnější okraj
	vmargin={15mm,24mm},	% Horní a dolní okraj
...
% Make multicolumn and multirow work in slovak language
\makeatletter
\begingroup
...
\include{text/strategie}

\include{text/proces_prodeje}

\include{text/vyber_systemu}

\include{text/implementace_systemu}

\include{text/provoz_sytemu}
